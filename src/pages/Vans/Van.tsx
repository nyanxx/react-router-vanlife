...
export default function Van({ van, linkTo = "/vans/" }: VanProps): JSX.Element {
    return (
        <Link to={`${linkTo}${van.id}`} className="bg-white text-[#161616] h-auto w-[365.33px] flex flex-col rounded-lg overflow-hidden cursor-pointer shadow-sm relative">
