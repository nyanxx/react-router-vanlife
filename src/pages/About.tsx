...
export default function About(): JSX.Element {
    ...
    useEffect(() => {
        ...
        aboutHead.current?.scrollIntoView({ behavior: "smooth", block: "center", inline: "nearest" })
    }, [])
    ...
    return (
        <section className="w-full pt-16">
            ...
            <div className="p-8 w-5xl mx-auto">
                <h2 ref={aboutHead} tabIndex={-1} className="text-[2.2rem] font-bold focus:outline-none">Don't <span className="underline underline-offset-4 decoration-red-500">squeeze</span> in a sedan when you could <span className="underline underline-offset-4 decoration-green-500">relax</span> in a van.</h2>
