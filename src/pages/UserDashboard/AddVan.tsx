  ...
  return (
    <section className="p-12 md:py-12 md:px-42 w-full text-[1.1rem] mx-auto">
      <div className="flex flex-col justify-center min-w-80 max-w-100 gap-4 bg-white border rounded-lg p-4 mx-auto">
        <h2 className="text-center text-[1.7rem] mb-[-0.7rem] font-medium">
          Add Van
        </h2>
        <input
        ...
        <textarea
          className={inputStyle}
          name="add-van-description"
          id="add-van-description"
          placeholder="The nature lorem is rem sudo pen..."
          rows={2}
        ></textarea>
        <input
          className={inputStyle}
          type="url"
          name="add-van-image-url"
          id="add-van-image-url"
          placeholder="https://vanimage.com/image/12"
        />
        <input
          className={inputStyle}
          type="text"
